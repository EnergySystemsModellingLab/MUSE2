...
///
/// It checks whether the process could be operating in the target region and year, accounting for
/// the process lifetime, and then checks whether it is active in the required time slice. In other
/// words, this checks if there is the _possibility_ of having an active process, although there is
